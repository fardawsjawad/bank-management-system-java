...
* **Model Layer**
  Contains entity classes such as `Account`, `Customer`, and `Transaction` that represent database tables.

* **DAO Layer (Data Access Object)**
  Handles all database operations such as inserting, updating, retrieving, and deleting records using JDBC.

* **Service Layer**
  Contains business logic and validations, acting as an intermediary between the DAO layer and the UI.

* **Utility Layer**
  Manages database connections and reusable helper methods.
...
3. Execute the SQL scripts to create required tables
4. Update database credentials in the DB utility class
